    ...
    <>
      <div id="about" className="bg-lightBlue">
        ...
        <div className="md:px-9 flex flex-col md:flex-row  pb-5">
          ...
          <div className="md:w-2/3 w-2/3 mx-auto md:pt-0 pt-10">
            ...
            <p className="md:mx-9 about-text pt-2">Looking ahead, I am excited about the prospect of channeling my skills and enthusiasm into a dynamic team. I believe in fostering collaboration and leveraging collective expertise to drive impactful results. </p>
            <p className="md:mx-9 about-text pt-2">Feel free to explore my projects, where you'll find evidence of my problem-solving abilities and innovative mindset. Don't hesitate to reach out—I'm always open to new opportunities and collaborations.! </p>
          </div>
        </div>
      </div>
    </>
