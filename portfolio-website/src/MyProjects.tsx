...
export default function MyProjects() {
  return (
    ...
    <div className="flex flex-wrap justify-around">
        <EachProject title={'Advanced Building Services'} url={'https://absi-website.vercel.app/'} image={'absi-photo.png'} description={`Advanced Building Services, is a leading HVAC company for which I developed an informative, user-friendly webpage. The site effectively showcases the company's services and integrates EmailJS to facilitate seamless communication between the business and its clients. I prioritized optimizing the user experience across all devices, ensuring that the website is fully responsive and intuitive on both mobile and desktop platforms.`}  skills={['React', 'TypeScript', 'Tailwind CSS', 'CSS3', 'HTML5', 'EmailJS', 'Vite']}/>
