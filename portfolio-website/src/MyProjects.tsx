...
export default function MyProjects() {
  return (
    ...
    <div className="flex flex-wrap justify-around">
        <EachProject title={'Advanced Building Services, Inc'} url={'https://absi-website.vercel.app/'} image={'book-store-photo.png'} description={'in progress'}  skills={['React', 'TypeScript', 'Tailwind CSS', 'CSS3', 'HTML5', 'EmailJS', 'Vite']}/>
